class User < ApplicationRecord
  ...
  # 多分has_manyに渡された名前と実際のクラス名が異なる時に
  # class_nameで都合をつけてる気がする
  ...
  # has_many through で多対多の関連付けができる
  # :sourceパラメーターでfollowing配列の元はfollowed idの集合であるとrailsに伝える
